...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    sort(this->open_list.begin(), this->open_list.end(),[] (const RouteModel::Node* a , const RouteModel::Node* b ) 
       ...
       RouteModel::Node* NodeLowestSum = this->open_list.back();
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    path_found.push_back(*next_node);  //Add the next node which the start_node
    std::reverse(path_found.begin(), path_found.end()) ; //reverse the vector to get it in the correct order
